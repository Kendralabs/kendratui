...
impl SubagentManager {
    ...
    pub async fn spawn(
        ...
        debug_logger: Option<&kendra_runtime::SessionDebugLogger>,
        ...
        let system_prompt = {
            ...
            let instructions = kendra_context::discover_instruction_files(wd);
        ...
        // Build tool context
        let mut tool_context = kendra_tools_core::ToolContext::new(working_dir);
