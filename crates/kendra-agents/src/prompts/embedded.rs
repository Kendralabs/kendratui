...
pub const SUBAGENTS_SUBAGENT_BACKEND: &str =
    include_str!("../../templates/subagents/subagent-backend.md");
pub const SUBAGENTS_SUBAGENT_FRONTEND: &str =
    include_str!("../../templates/subagents/subagent-frontend.md");
pub const SUBAGENTS_SUBAGENT_SECURITY: &str =
    include_str!("../../templates/subagents/subagent-security.md");
...
pub const TEMPLATE_COUNT: usize = 81;
...
pub static TEMPLATES: LazyLock<HashMap<&'static str, &'static str>> = LazyLock::new(|| {
    ...
    m.insert(
        "subagents/subagent-security.md",
        SUBAGENTS_SUBAGENT_SECURITY,
    );
    m.insert(
        "subagents/subagent-frontend.md",
        SUBAGENTS_SUBAGENT_FRONTEND,
    );
    m.insert("subagents/subagent-backend.md", SUBAGENTS_SUBAGENT_BACKEND);
    m.insert(
