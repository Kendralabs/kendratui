...
/// ```
/// use std::collections::HashMap;
/// use kendra_agents::prompts::substitute_variables;
///
/// let mut vars = HashMap::new();
/// vars.insert("session_id".into(), "abc-123".into());
/// let result = substitute_variables("path: ~/.kendra/sessions/{{session_id}}/", &vars);
/// assert_eq!(result, "path: ~/.kendra/sessions/abc-123/");
/// ```
