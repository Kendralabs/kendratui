...
//!
//! Mirrors `kendra/core/base/abstract/base_agent.py`.
...
pub struct AgentDeps {
    ...
    /// Optional governed orchestrator for phase-gated execution.
    pub orchestrator: Option<Arc<Mutex<kendra_runtime::GovernedOrchestrator>>>,
}
...
impl AgentDeps {
    ...
    pub fn with_orchestrator(
        mut self,
        orchestrator: Arc<Mutex<kendra_runtime::GovernedOrchestrator>>,
    ) -> Self {
...
impl TaskMonitor for kendra_runtime::InterruptToken {
    fn should_interrupt(&self) -> bool {
        self.is_requested()
    }
