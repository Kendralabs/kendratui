...
After completing code changes (especially multi-step plans), verify your work before calling TaskStop:
...
4. **Report results**: Include verification outcome in your TaskStop summary
