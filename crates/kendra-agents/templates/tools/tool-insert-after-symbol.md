...
- When to use vs Edit: use insert_after_symbol for structured insertion that should appear directly after a specific code element; use Edit for general text replacement anywhere in a file
