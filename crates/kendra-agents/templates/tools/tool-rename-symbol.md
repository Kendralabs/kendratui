...
- When to use vs search-and-replace (Edit with match_all):
  - Use rename_symbol for safe semantic renames — it understands code structure and only changes actual references
  - Use Edit match_all for simple text replacement when the string is unique and context doesn't matter
