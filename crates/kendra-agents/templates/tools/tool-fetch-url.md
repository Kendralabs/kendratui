...
- IMPORTANT: Never generate or guess URLs. Only use URLs from user messages, local files, or WebSearch results
- For GitHub URLs, prefer using Bash with the gh CLI instead (e.g., gh pr view, gh issue view, gh api)
