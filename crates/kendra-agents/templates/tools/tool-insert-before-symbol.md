...
- When to use vs Edit: use insert_before_symbol for structured insertion that should appear directly before a specific code element; use Edit for general text replacement anywhere in a file
