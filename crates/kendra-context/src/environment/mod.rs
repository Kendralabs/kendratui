...
//!
//! Mirrors Python's `kendra/core/agents/components/prompts/environment.py`.
...
pub struct EnvironmentContext {
    ...
    /// Project instruction files (AGENTS.md, CLAUDE.md, .kendra/instructions.md).
...
fn load_project_memory(working_dir: &Path) -> Option<String> {
    let paths = kendra_config::paths::Paths::new(Some(working_dir.to_path_buf()));
