...
use kendra_models::file_change::FileChange;
use kendra_models::message::ToolCall;
use kendra_models::session::Session;
use kendra_models::transition::{TransitionError, ValidateTransition};
...
pub enum SessionEvent {
    ...
    MessageAdded {
        role: String,
        content: String,
        #[serde(with = "kendra_models::datetime_compat")]
