...
//!
//! Maintains a parallel shadow git repository at `~/.kendra/snapshot/<project_id>/`
...
impl SnapshotManager {
    ...
    pub fn new(project_dir: &str) -> Self {
        ...
        let shadow_dir = kendra_config::Paths::default()
            .data_dir()
            .join("snapshot")
            .join(&project_id);
    ...
    pub fn track(&mut self) -> Option<String> {
        ...
        // Exclude kendra's own generated artifacts so read-only exploration does
