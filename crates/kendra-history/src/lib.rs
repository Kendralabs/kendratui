//! Session history management for KendraCLI.
//!
//! This crate provides:
//! - **SessionManager**: JSON read/write to ~/.kendra/sessions/
...
pub use sidechain::{EntryKind, SidechainReader, SidechainWriter, TranscriptEntry};
