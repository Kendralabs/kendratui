...
use kendra_models::session::Session;
use kendra_models::transition::ValidateTransition;
...
fn make_session(archived: bool, message_count: usize) -> Session {
    ...
    for _ in 0..message_count {
        session.messages.push(kendra_models::message::ChatMessage {
            role: kendra_models::message::Role::User,
            content: "msg".into(),
            timestamp: Utc::now(),
            metadata: HashMap::new(),
            tool_calls: vec![],
