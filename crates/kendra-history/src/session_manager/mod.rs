//! Session manager: JSON read/write to ~/.kendra/sessions/.
//!
...
use kendra_models::Session;
use kendra_models::message::ChatMessage;
use kendra_models::validator::{filter_and_repair_messages, validate_message};
...
impl SessionManager {
    ...
    ///
    /// The `session_dir` is typically `~/.kendra/projects/{encoded-path}/`
    /// or `~/.kendra/sessions/` for the legacy global directory.
