//! Runtime services for the KendraCLI AI coding assistant.
//!
//! This crate provides:
...
pub use constants::{
    AutonomyLevel, PermissionMode, SAFE_COMMANDS, extract_command_prefix, is_safe_command,
};
...
pub use orchestration::GovernedOrchestrator;
