...
use kendra_agents::traits::{AgentEventCallback, AgentResult};
use kendra_context::{ArtifactIndex, ContextCompactor};
use kendra_history::SessionManager;
use kendra_models::AppConfig;
use kendra_runtime::{CostTracker, InterruptToken, SessionDebugLogger};
...
pub struct BackgroundRuntime {
    ...
    http_client: Arc<kendra_http::adapted_client::AdaptedClient>,
    hook_manager: Arc<kendra_hooks::HookManager>,
    ...
    todo_manager: Arc<Mutex<kendra_runtime::TodoManager>>,
...
impl BackgroundRuntime {
    ...
    pub async fn run_query(
    ...
    ) -> Result<AgentResult, kendra_agents::traits::AgentError> {
        ...
        let result = self
            ...
            .run(
                ...
                None, // No orchestrator for background tasks
