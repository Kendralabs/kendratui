...
//!
//! Mirrors `kendra/core/context_engineering/tools/handlers/process_handlers.py`.
//!
//! Responsibilities:
...
use kendra_runtime::approval::ApprovalRulesManager;
...
impl ToolHandler for ProcessHandler {
    ...
    fn pre_check(&self, _tool_name: &str, args: &HashMap<String, Value>) -> PreCheckResult {
        ...
        {
            use kendra_runtime::approval::RuleAction;
            match rule.action {
                RuleAction::AutoDeny => {
