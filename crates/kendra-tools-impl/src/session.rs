...
use kendra_config::Paths;
use kendra_history::SessionManager;
use kendra_models::SessionMetadata;
use kendra_runtime::redact_secrets;
use kendra_tools_core::{BaseTool, ToolContext, ToolResult};

/// Tool for browsing and searching past conversation sessions.
///
/// Uses project-scoped session directories via `kendra_config::Paths`
/// and the `SessionManager` API from `kendra-history`.
#[derive(Debug)]
