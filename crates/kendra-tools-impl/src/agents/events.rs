...
pub enum SubagentEvent {
    ...
    BackgroundSpawned {
        ...
        description: String,
        session_id: String,
        interrupt_token: kendra_runtime::InterruptToken,
    },
...
impl kendra_agents::SubagentProgressCallback for ChannelProgressCallback {
...
impl kendra_agents::SubagentProgressCallback for BackgroundProgressCallback {
