...
pub struct App {
    ...
    approval_response_tx:
        Option<tokio::sync::oneshot::Sender<kendra_runtime::ToolApprovalDecision>>,
    ...
    plan_approval_response_tx: Option<tokio::sync::oneshot::Sender<kendra_runtime::PlanDecision>>,
